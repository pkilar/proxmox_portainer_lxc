...
# Create a temporary container environment setup script
...
# Download the latest Debian 12 LXC template
...
pveam download template $TEMPLATE >/dev/null ||
...
TEMPLATE_STRING="template:vztmpl/${TEMPLATE}"
...
# Get network details and show the completion message
